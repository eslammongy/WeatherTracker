...
final _entities = <obx_int.ModelEntity>[
  obx_int.ModelEntity(
      id: const obx_int.IdUid(1, 8514214003713391047),
      name: 'WeatherEntity',
      lastPropertyId: const obx_int.IdUid(1, 6894261792852587698),
      flags: 0,
      properties: <obx_int.ModelProperty>[
        obx_int.ModelProperty(
            id: const obx_int.IdUid(1, 6894261792852587698),
            name: 'id',
            type: 6,
            flags: 1)
      ],
...
obx_int.ModelDefinition getObjectBoxModel() {
  final model = obx_int.ModelInfo(
      entities: _entities,
      lastEntityId: const obx_int.IdUid(1, 8514214003713391047),
